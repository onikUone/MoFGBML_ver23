...
public class RemoveNotWinnerProcessing extends SimplePostProcessing {

	private DataSet data;

	public RemoveNotWinnerProcessing(DataSet data) {
		this.data = data;
	}
	...
	public Classifier postProcess(Classifier classifier) {
		...
		for(int i = 0; i < data.getDataSize(); i++) {
			...
			if( pattern.getTrueClass().toString().equals(
				winnerRule.getConsequent().getClassLabel().toString()) ) {
